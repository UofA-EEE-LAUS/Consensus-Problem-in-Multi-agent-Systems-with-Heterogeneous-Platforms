...
class PositionHlCommander:
	...
	def __init__(self, crazyflie,
				 ...
				 default_height=0.4,
				 controller=CONTROLLER_MELLINGER):
		"""
	...
	def take_off(self, height=DEFAULT, velocity=0.2):
		"""
	...
	def land(self, velocity=0.1):
		...
		if self._is_flying:
			...
			self._hl_commander.land(0.09, duration_s)
			time.sleep(duration_s)
			self._z = 0.0
	...
	def _activate_controller(self):
		...
		time.sleep(0.1)
		self._cf.param.set_value('ctrlMel.kp_z', '0.6')
